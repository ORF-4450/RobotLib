...
public final class Mk4iSwerveModuleHelper 
{
            ...
            double steerOffset) 
   {
    ...
    //------ Start of Neo-Neo550 section.
    
    /**
     * Creates a Mk4i swerve module that uses NEOs for driving and ENO550s for steering.
     * Module information is displayed in the specified ShuffleBoard container.
     *
     * @param position		   The module location on the robot drive base.
     * @param container        The container to display module information in.
    ...
    /**
     * Creates a Mk4i swerve module that uses NEOs for driving and NEO550s for steering.
     * Module information is displayed in the specified ShuffleBoard container.
     *
     * @param position		   The module location on the robot drive base.
     * @param container        The container to display module information in.
    ...
    public enum GearRatio 
    {
    	...
    	T12(SdsModuleConfigurations.MAXSWERVE_T12),
    	T13(SdsModuleConfigurations.MAXSWERVE_T13),
    	T14(SdsModuleConfigurations.MAXSWERVE_T14);
